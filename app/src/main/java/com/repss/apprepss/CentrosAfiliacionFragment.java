...
public class CentrosAfiliacionFragment extends Fragment implements LocationListener{
    ...
    public CentrosAfiliacionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_centros_afiliacion, container, false);
        ...
        mapView = (MapView)view.findViewById(R.id.centrosAfiliacionMapView);
