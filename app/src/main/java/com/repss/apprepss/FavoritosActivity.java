...
public class FavoritosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while(cursor.moveToNext()){
            ...
            mAdapterBusqueda = new BusquedaAdapter(this, listaDependenciaSalud);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for(DependenciaSalud dependencia : listaDependenciaSalud){
                    if(ds.Nombre.equals(dependencia.Nombre)){
                        Intent detalles = new Intent(FavoritosActivity.this,DependenciaSaludDetalles.class);
                        detalles.putExtra("id",String.valueOf(dependencia.Nombre));
